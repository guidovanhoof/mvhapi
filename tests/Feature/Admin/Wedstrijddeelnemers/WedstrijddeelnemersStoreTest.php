...
class WedstrijddeelnemersStoreTest extends TestCase
{
    ...
    public function wedstrijddeelnemerAanmaken()
    {
        ...
        $this->assertInDatabase($this->wedstrijddeelnemer);
    }
     ...
     * @param Wedstrijddeelnemer $wedstrijddeelnemer
     */
    private function assertInDatabase(Wedstrijddeelnemer $wedstrijddeelnemer): void
    {
        $this
            ->assertDatabaseHas(
                'wedstrijddeelnemers',
            ...
            ->assertJson($wedstrijddeelnemer->toJson())
        ;
    }
}
